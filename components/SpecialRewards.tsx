...
export const SpecialRewards = React.memo(() => {
  return (
    <div className="w-[280px] -mt-24 bg-gradient-to-br from-purple-900/40 via-black/40 to-purple-900/40 backdrop-blur-md rounded-xl p-3 sm:p-4 border border-purple-500/30 shadow-[0_0_15px_rgba(168,85,247,0.15)] hover:shadow-[0_0_25px_rgba(168,85,247,0.25)] transition-all duration-300 animate-float scale-[0.85] sm:scale-100 origin-top-left">
      ...
      <div className="relative text-xs sm:text-sm text-center text-purple-200 mb-3 font-medium">
        Guaranteed rewards await you! 🎁
      </div>
      
      <div className="relative space-y-2.5 sm:space-y-3">
        <div className="p-2.5 sm:p-3 bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-lg hover:from-purple-800/40 hover:to-pink-800/40 transition-all duration-300 border border-purple-500/10 hover:scale-[1.02] hover:-translate-y-0.5 hover:shadow-lg">
          <h3 className="text-xs sm:text-sm font-bold text-purple-200 flex items-center justify-between mb-2">
            <span className="text-lg sm:text-xl mr-2">💎</span>
            <span className="bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text text-transparent flex-1">
              1,000,000 KT+
            </span>
          </h3>
          <ul className="text-[10px] sm:text-xs text-purple-300 list-disc list-inside space-y-1">
        ...
        <div className="p-2 bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg text-[10px] sm:text-xs text-blue-300 border border-blue-500/10 hover:from-blue-800/40 hover:to-purple-800/40 transition-all duration-300 hover:scale-[1.02] hover:-translate-y-0.5 hover:shadow-lg">
